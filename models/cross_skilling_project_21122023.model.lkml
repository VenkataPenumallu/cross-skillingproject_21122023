...
#/views/billion_orders.view.lkml - Sample file path

datagroup: cross_skilling_project_21122023_default_datagroup {
  # sql_trigger: SELECT MAX(id) FROM etl_log;;
  max_cache_age: "1 hour"
}

persist_with: cross_skilling_project_21122023_default_datagroup
